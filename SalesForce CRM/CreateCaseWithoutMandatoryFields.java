...
public class CreateCaseWithoutMandatoryFields extends BaseClass {
	String[][] data;
	@Test(dataProvider="CreateCaseWithoutMandatoryFields")
	public void CreateCaseWithoutMandatoryFields(String sub,String desc)  throws InterruptedException {
