...
public class CreateLegalEntityWithoutManatoryFields extends BaseClass {
	String[][] data;
	@Test(dataProvider="CreateLegalEntityWithoutManatoryFields")
	public void CreateLegalEntityWithoutManatoryFields(String cname,String desc) throws InterruptedException {
