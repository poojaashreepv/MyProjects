...
public class CreateNewOpportunity1 extends BaseClass {
	...
	public void CreateNewOpportunity() {
        ...
        driver.findElement(By.xpath("(//input[@class='slds-input'])[4]")).sendKeys("Salesforce Automation by Poojaashree");
        //Thread.sleep(2000);
        ...
        if(text.contains("Salesforce Automation by Poojaashree")){
