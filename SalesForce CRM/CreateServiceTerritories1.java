...
public class CreateServiceTerritories1 extends BaseClass {
	String[][] data;
	@Test(dataProvider="CreateServiceTerritories")
	public void CreateServiceTerritories(String name,String city,String state,String country,String zipcode) {
	    ...
	    String serviceTerritoryName = driver.findElement(By.xpath("//lightning-formatted-text[@slot='primaryField']")).getText();//getAttribute("value");
