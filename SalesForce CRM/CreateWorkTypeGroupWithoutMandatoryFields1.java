...
public class CreateWorkTypeGroupWithoutMandatoryFields extends BaseClass {
	String[][] data;
	@Test(dataProvider="CreateWorkTypeGroupWithoutMandatoryFields")
	public void CreateWorkTypeGroupWithoutMandatoryFields(String desc) throws InterruptedException {
