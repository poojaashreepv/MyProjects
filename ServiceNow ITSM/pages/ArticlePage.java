...
public class ArticlePage extends BaseClass {
	...
	public ArticlePage switchToFrame() throws IOException {
		try {
	...
	public ArticlePage clickOnCreateAnArticleButton() throws IOException {
		try {
	...
	public ArticlePage getArticleNumberText() throws IOException {
		try {
	...
	public ArticlePage enterKnowledgeBase(String knowbase) throws IOException {
		try {
	...
	public ArticlePage enterShortDescription(String sdesc) throws IOException {
		try {
	...
	public ArticlePage enterCategory(String categ) throws IOException {
		try {
	...
	public ArticlePage enterShortDescription1(String sdesc1) throws IOException {
		try {
