...
public class CallerPage extends BaseClass {
	...
	public CallerPage switchToFrame() throws IOException {
		try {
	...
	public CallerPage clickOnNewButton() throws IOException {
		try {
	...
	public CallerPage enterFirstName(String fname) throws IOException {
		try {
	...
	public CallerPage enterLastName(String lname) throws IOException {
		try {
	...
	public CallerPage enterTitle(String title) throws IOException {
		try {
	...
	public CallerPage enterEmail(String email) throws IOException {
		try {
	...
	public CallerPage ebterBusinessPhone(String bphoneno) throws IOException {
		try {
	...
	public CallerPage enterMobilePhone(String mphoneno) throws IOException {
		try {
	...
	public CallerPage clickOnSubmitButton() throws IOException {
		try {
	...
	public CallerPage enterFirstNameOnSearchField(String fname1) throws IOException {
		try {
	...
	public CallerPage clickOnFirstName() throws IOException {
		try {
	...
	public CallerPage getFirstNameText() throws IOException {
		try {
	...
	public CallerPage getLastNameText() throws IOException {
		try {
	...
	public CallerPage getTitleText() throws IOException {
		try {
	...
	public CallerPage getEmailText() throws IOException {
		try {
	...
	public CallerPage getBusinessPhoneText() throws IOException {
		try {
	...
	public CallerPage getMobilePhoneText() throws IOException {
		try {
	...
	public void verifyCallerCreation() throws IOException {
		 try {
	...
	public CallerPage enterFirstNameOnSearchField1(String fname2) throws IOException {
		 try {
	...
	public CallerPage clickOnFirstName1() throws IOException {
		try {
			driver.findElement(By.xpath("//table[@id='sys_user_table']/tbody/tr[1]/td[3]/a")).click();
			reportStep("Pass", "First Name is Clicked Successfully");
		} 
	...
	public CallerPage clearBusinessPhone() throws IOException {
		try {
	...
	public CallerPage enterBusinessPhone(String bphoneno1) throws IOException {
		try {
	...
	public CallerPage getBusinessPhoneText1() throws IOException {
		try {
	...
	public CallerPage clickOnUpdateButton() throws IOException {
		try {
	...
	public CallerPage clickOnFirstNameDisplayedInTable() throws IOException {
		try {
			driver.findElement(By.xpath("//table[@id='sys_user_table']/tbody/tr[1]/td[3]/a")).click();
	...
	public CallerPage getBusinessPhoneText2() throws IOException {
		try {
	...
	public void verifyCallerUpdation() throws IOException {
		try {
	...
	public CallerPage enterFirstNameOnSearchField2(String fname3) throws IOException {
		 try {
	...
	public CallerPage clickOnFirstName2() throws IOException {
		try {
			driver.findElement(By.xpath("//table[@id='sys_user_table']/tbody/tr[1]/td[3]/a")).click();
			reportStep("Pass", "First Name is Clicked Successfully");
		} 
	...
	public CallerPage clickOnDeleteButton() throws IOException {
		try {
	...
	public CallerPage clickOndeleteConfirmation() throws IOException {
		try {
	...
	public void verifyCallerDeletion() throws IOException {
		try {
