...
public class HomePage extends BaseClass {
	...
	public HomePage clickOnAll() throws IOException {//ci //uei //ri //di //cwf //om //do //cp //ucp //cnc //uec //dc
		try {
	...
	public HomePage searchOnKey(String searchKey) throws IOException {//ci //uei //ri //di //cwf 
		try {
    ...
    public HomePage searchOnKey1(String searchKey1) throws IOException {//om //do
    	try {
    ...
    public HomePage searchOnKey2(String searchKey2) throws IOException {//cp //ucp
    	try {
    ...
    public HomePage searchOnKey3(String searchKey3) throws IOException {//cnc //uec //dc
    	try {
    ...
    public HomePage searchOnKey4(String searchKey4) throws IOException {//ca //fm
    	try {
