...
public class IncidentPage extends BaseClass {
	...
	public IncidentPage switchToFrame() throws IOException {
		try {
	 ...
	 public IncidentPage clickOnNewButton() throws IOException {
		 try {
	 ...
	 public IncidentPage getIncidentNumber() throws IOException { 
		 try {
	 ...
	 public IncidentPage enterDescription(String descp) throws IOException {
		 try {
	 ...
	 public IncidentPage clickOnSubmitButton() throws IOException {
		 try {
	 ...
	 public IncidentPage clickOnNumberInSearchDropdown() throws IOException {
		 try {
	 ...
	 public IncidentPage enterIncidentNumberInSearchField() throws IOException {
		 try {
	 ...
	 public IncidentPage enterIncidentNumberInSearchField1(String incNum) throws IOException {
		 try {
	 ...
	 public IncidentPage enterIncidentNumberInSearchField2(String incNum1) throws IOException {
		 try {
	 ...
	 public IncidentPage enterIncidentNumberInSearchField3(String incNum2) throws IOException {
		 try {
	 ...
	 public IncidentPage getFirstIncidentNumber() throws IOException {
		 try {
	 ...
	 public void verifyNewIncident() throws IOException {
		 try {
	 ...
	 public IncidentPage clickOnFirstIncidentNumber() throws IOException {
		 try {
	 ...
	 public IncidentPage updateUrgency() throws IOException {
		 try {
	 ...
	 public IncidentPage getUrgencyText() throws IOException {
		 try {
	 ...
	 public IncidentPage updateState() throws IOException {
		 try {
	 ...
	 public IncidentPage getStateText() throws IOException {
		 try {
	 ...
	 public IncidentPage clickOnUpdateButton() throws IOException {
		 try {
			driver.findElement(By.xpath("(//button[@type='submit'])[1]")).click();
			Thread.sleep(2000);
	 ...
	 public void verifyPriorityState() throws IOException {
		 try {
	 ...
	 public IncidentPage updateState1() throws IOException {
		try {
			WebElement stateDropdown = driver.findElement(By.name("incident.state"));
			Select statedd=new Select(stateDropdown);
	 ...
	 public IncidentPage getIncidentNumber1() throws IOException {
		 try {
			incidentNumber = driver.findElement(By.xpath("//input[@id='incident.number']")).getAttribute("value");
			System.out.println("Incident Number is " +incidentNumber);
			reportStep("Pass", "Incident Number Text is got Successfully");
	 ...
	 public IncidentPage clickOnDeleteButton() throws IOException {
		 try {
	 ...
	 public IncidentPage clickOnDeleteConfirmationButton() throws IOException {
		 try {
	 ...
	 public void verifyDeleteIncident() throws IOException {
		 try {
	 ...
	 public IncidentPage clearCallerField() throws IOException {
		 try {
	 ...
	 public IncidentPage getErrorMessageText() throws IOException {
		 try {
