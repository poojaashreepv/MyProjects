...
public class ProposalPage extends BaseClass {
	...
	public ProposalPage switchToFrame() throws IOException {
		try {
	...
	public ProposalPage clickOnNewButton() throws IOException {
		 try {
	...
	public ProposalPage getProposalNumberText() throws IOException {
		try {
	...
	public ProposalPage enterShortDescription() throws InterruptedException, IOException {
		try {
	...
	public ProposalPage clickOnSubmitButton() throws IOException {
		 try {
	...
	public ProposalPage getRowSize() throws IOException {
		 try {
	...
	public ProposalPage getProposalNumberList() throws IOException {
	         try {
	...
	public void verifyProposalCreation() throws IOException {
		 try {
	...
	public ProposalPage enterProposalNumberInSearchField(String proposalNum) throws IOException {
		try {
	...
	public ProposalPage clickOnFirstProposalNumberInTable() throws IOException {
		try {
	...
	public ProposalPage getFirstProposalNumberText() throws IOException {
		try {
	...
	public ProposalPage clearCategoryField() throws IOException {
		try {
	...
	public ProposalPage enterCategory(String category) throws IOException {
		try {
	...
	public ProposalPage clearAssignmentGroup() throws IOException {
		try {
	...
	public ProposalPage enterAssignmentGroup(String assgroup) throws IOException {
		try {
	...
	public ProposalPage clearAssignTo() throws IOException {
		try {
	...
	public ProposalPage enterAssignTo(String assTo) throws IOException {
		try {
	...
	public ProposalPage clickOnInProgressState() throws IOException {
		try {
	...
	public ProposalPage clickOnChangeRequestValues() throws IOException {
		try {
	...
	public ProposalPage clearShortDescription() throws IOException {
		try {
	...
	public ProposalPage enterShortDescription1(String sdescp) throws IOException {
		try {
	...
	public ProposalPage clearAssignmentGroup1() throws IOException {
		try {
	...
	public ProposalPage enterAssignmentGroup1(String assgroup1) throws IOException {
		try {
	...
	public ProposalPage clearJustification() throws IOException {
		try {
	...
	public ProposalPage enterJustification(String jus) throws IOException {
		try {
	...
	public ProposalPage clearRiskAndImpactAnalysis() throws IOException {
		try {
	...
	public ProposalPage enterRiskAndImpactAnalysis(String riskana) throws IOException {
		try {
	...
	public ProposalPage clickOnUpdateButton() throws IOException {
		try {
			driver.findElement(By.xpath("(//button[@type='submit'])[1]")).click();
			Thread.sleep(2000);
	...
	public ProposalPage clickOnNumberInSearchDropdown1() throws IOException {
		try {
	...
	public ProposalPage enterProposalNumberInSearchField() throws IOException {
		try {
	...
	public ProposalPage clickOnFirstProposalNumber1() throws IOException {
		try {
			driver.findElement(By.xpath("//table[@id='std_change_proposal_table']/tbody/tr[1]/td[3]/a")).click();
			reportStep("Pass", "First Proposal Number is Clicked Successfully");
	...
	public ProposalPage getStateText() throws IOException {
		try {
			driver.findElement(By.xpath("//table[@id='std_change_proposal_table']/tbody/tr[1]/td[3]/a")).click();
	...
	public ProposalPage getAssignToText() throws IOException {
		try {
	...
	public void verifyStateAndAssignTo() throws IOException {
		try {
