...
public class ServiceCatalogPage extends BaseClass {
	...
	public ServiceCatalogPage switchToFrame() throws IOException {
		try {
	...
	public ServiceCatalogPage clickOnMobiles() throws IOException {
		try {
	...
	public ServiceCatalogPage clickOnIphone13() throws IOException {
		try {
	...
	public ServiceCatalogPage clickOnNoforReplacement() throws IOException {
		try {
	...
	public ServiceCatalogPage clickUnlimitedMonthlyAllowance() throws IOException {
		try {
	...
	public ServiceCatalogPage clickOnPinkColor() throws IOException {
		try {
	...
	public ServiceCatalogPage clickOn128GB() throws IOException {
		try {
	...
	public ServiceCatalogPage clickOnOrderNow() throws IOException {
		try {
	...
	public ServiceCatalogPage getOrderPlacedMsgText() throws IOException {
		try {
	...
	public ServiceCatalogPage verifyOrderPlaced() throws IOException {
                try {
	...
	public void getTextRequestNumber() throws IOException {
		try {
	...
	public ServiceCatalogPage getTextRequestNumber1() throws IOException {
		try {
			String requestNumber = driver.findElement(By.xpath("//a[@id='requesturl']")).getText();
			System.out.println("Request Number is " +requestNumber);
			reportStep("Pass", "Request Number Text is got Successfully");
	...
	public ServiceCatalogPage clickOnDisplayedReqestNumber() throws IOException {
		 try {
	...
	public ServiceCatalogPage clickOnDeleteButton() throws IOException {
		try {
	...
	public ServiceCatalogPage clickOnDeleteConfirmation() throws IOException {
		try {
	...
	public ServiceCatalogPage getOrderStatus() throws IOException {
		try {
	...
	public void verifyOrderDeleted() throws IOException {
		try {
